...
- **Solar**: 6 V / 4.5 W panel (~750 mA peak at 6 V). Verify Voc < 7 V before connecting; add a Schottky diode in series with the panel's positive lead for reverse-current / reverse-polarity protection. **1N5822** (40 V / 3 A) is the chosen part — running well below its 3 A rating gives a lower forward drop (~0.3 V at our 750 mA peak) than the 1N5817 the original plan called for, leaving more headroom inside the FireBeetle's 4.5–6 V solar input window. 1N5819 also works (slightly higher V_F, ~0.5 V).
